module id.cranium.erp.inventory {
	...
	opens db.migration.inventory;
	opens db.test.inventory;
	opens id.cranium.erp.inventory.inventoryservice to spring.core, spring.beans, spring.context;
	opens id.cranium.erp.inventory.configuration to spring.core, spring.beans, spring.context;
	opens id.cranium.erp.inventory.configuration.mapper to spring.beans;
	opens id.cranium.erp.inventory.client.user to spring.core, spring.beans;
	opens id.cranium.erp.inventory.service to spring.core, spring.beans, spring.aop;
	opens id.cranium.erp.inventory.controller to spring.core, spring.beans, spring.web, spring.aop;
	opens id.cranium.erp.inventory.entity to spring.core, spring.beans, org.hibernate.orm.core, spring.data.commons;
	opens id.cranium.erp.inventory.validator to org.hibernate.validator;
	opens id.cranium.erp.inventory.util to spring.core, spring.beans;
	opens id.cranium.erp.inventory.security to spring.core, spring.beans;
	opens id.cranium.erp.inventory.eventlistener.cron to spring.core, spring.beans;
	opens id.cranium.erp.inventory.contract;
}
