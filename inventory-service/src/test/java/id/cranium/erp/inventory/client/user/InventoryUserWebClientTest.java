 ...
 * 
 * @WithMockCustomUser(userId = 12L, username = "user-12", authorities =
 * {"DOMAIN_MENU_PERMISSION","MASTER_PRODUCT_READ"})
 * 
 ...
 * assertThat(userDto.getCreatedAt()).isEqualTo(LocalDateTime.of(2023,
 * Month.JANUARY, 30, 15, 30, 59));
 * assertThat(userDto.getCreatedBy()).isEqualTo(1L);
 * assertThat(userDto.getUpdatedAt()).isEqualTo(LocalDateTime.of(2023,
 * Month.JANUARY, 30, 15, 30, 59));
 ...
 * masterUserWebClient.getUserById(20L));
 * ApiErrorDto apiErrorDto = new
 * ObjectMapper().readValue(exception.getMessage(), ApiErrorDto.class);
