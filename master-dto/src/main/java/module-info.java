module id.cranium.erp.master.dto {
    ...
    opens id.cranium.erp.master.configurationdto to spring.core,spring.beans,spring.context;
    opens id.cranium.erp.master.masterdto to spring.core,spring.beans,spring.context;
    opens id.cranium.erp.master.dto to com.fasterxml.jackson.databind,org.hibernate.validator;
    opens id.cranium.erp.master.validator.constraint to org.hibernate.validator;
    exports id.cranium.erp.master.dto;
    exports id.cranium.erp.master.event;
    exports id.cranium.erp.master.enums;
    exports id.cranium.erp.master.validator.constraint;
}
