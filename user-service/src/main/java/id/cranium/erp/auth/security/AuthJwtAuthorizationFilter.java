...
@Slf4j
public class AuthJwtAuthorizationFilter extends OncePerRequestFilter {
...
*/
        ...
        if (isTokenValid) {
            ...
            try {
                ...
                LoginDto loginDto = loginService.findByAccessTokenStatusDeleted(userJwtUtil.extractAccessToken(jwtToken));
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        ...
        boolean result = path.startsWith(authTokenRequestMacher + "/");
        return !result;
    }
