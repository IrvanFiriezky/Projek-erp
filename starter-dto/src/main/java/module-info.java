module id.cranium.erp.starter.dto {
    ...
    opens id.cranium.erp.starter.configurationdto to spring.core,spring.beans,spring.context;
    opens id.cranium.erp.starter.starterdto to spring.core,spring.beans,spring.context;
    opens id.cranium.erp.starter.dto to com.fasterxml.jackson.databind,org.hibernate.validator;
    //opens id.cranium.erp.starter.validator.constraint to org.hibernate.validator;
    exports id.cranium.erp.starter.dto;
    exports id.cranium.erp.starter.event;
    exports id.cranium.erp.starter.enums;
    //exports id.cranium.erp.starter.validator.constraint;
}
